...
OUTPUT_CSV = "db_restaurant_reviews.csv" # name of the output database

MAX_API_CALLS = 800          # limit the number of API calls 
SLEEP_SECONDS = 0.2          # safety sleep
SEARCH_RADIUS_METERS = 600   # search radius for the searchNearby() API
GRID_STEP_METERS = 450       # overlap to avoid gaps

LANGUAGE_CODE = "fr" 
REGION_CODE = "FR"

# choose coordinates for the grid search 
